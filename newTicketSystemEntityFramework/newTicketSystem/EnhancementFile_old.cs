...
namespace newTicketSystem
{
    class EnhancementFile_old
    {
        ...
        public List<Records_old> ListEnhancements()
        {
        ...
        public List<Records_old> ListEnhancements(string searchterm)
        {
            List<Records_old> records = new List<Records_old>();
            try
            {
        ...
        public bool AddEnhancement(Enhancement_old enhancement)
        {
        ...
        public bool UpdateEnhancement(Records_old ticket)
        {
