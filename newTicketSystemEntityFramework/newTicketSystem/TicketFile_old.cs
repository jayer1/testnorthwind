...
namespace newTicketSystem
{
    class TicketFile_old
    {
        ...
        public List<Records_old> ListTickets()
        {
        ...
        public List<Records_old> ListTickets(string searchterm)
        {
            List<Records_old> records = new List<Records_old>();
            try
            {
        ...
        public bool AddTicket(Ticket_old ticket)
        {
        ...
        public bool UpdateTicket(Records_old ticket)
        {
            ...
            catch (Exception e)
            {
                ...
                internal IEnumerable<Records_old> ListEnhancements(string searchTerm)
        {
