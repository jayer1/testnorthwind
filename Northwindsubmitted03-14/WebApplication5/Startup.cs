...
namespace Northwind
{
    public class Startup
    {
        ...
        public void Configure(IApplicationBuilder app, IHostingEnvironment env)
        {
            ...
            app.UseStaticFiles(); //uncommented this - this allows the external js and css files to work
            app.UseMvcWithDefaultRoute();

            /*app.UseMvc(routes =>
            {
                routes.MapRoute("stuff", "{controller=Product}/{action=Category}/{action=Product}");
            });*/
        }
    }
}
